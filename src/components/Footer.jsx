    ...
    <footer className="bg-gray-900 border-t border-gray-700 pt-10 pb-6 px-4">
        ...
        <div className="mt-8 text-center text-gray-500 text-xs">
            ...
            <span className="block mt-1">
                ...
                programmers by <span className="text-amber-400">Shaurya Agrawal</span> <span className="text-cyan-400">♥</span>  <span className="text-cyan-400">Priyanshu Kumar Pandey</span>  <span className="text-fuchsia-600">♥</span> <span className="text-fuchsia-600">Shreyash Kumar Dheemar</span>
            </span >
        </div>
    </footer>
);
